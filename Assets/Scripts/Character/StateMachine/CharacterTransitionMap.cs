...
namespace Character.StateMachine
{
    ...
    public static class CharacterTransitionMap
    {
        private static readonly Dictionary<CharacterStateId, HashSet<CharacterStateId>> _allowed =
            ...
            {
                { CharacterStateId.Idle,   new HashSet<CharacterStateId> { CharacterStateId.Move, CharacterStateId.Sprint, CharacterStateId.Attack, CharacterStateId.Dodge,CharacterStateId.Guard, CharacterStateId.Hit, CharacterStateId.Dead, CharacterStateId.PostureBroken, CharacterStateId.Parry, CharacterStateId.Parried} },
                { CharacterStateId.Move,   new HashSet<CharacterStateId> { CharacterStateId.Idle, CharacterStateId.Sprint, CharacterStateId.Attack, CharacterStateId.Dodge,CharacterStateId.Guard, CharacterStateId.Hit, CharacterStateId.Dead, CharacterStateId.PostureBroken, CharacterStateId.Parry, CharacterStateId.Parried } },
                ...
                { CharacterStateId.PostureBroken,new HashSet<CharacterStateId>{CharacterStateId.Idle,CharacterStateId.Move,CharacterStateId.Dead, CharacterStateId.Parried}},
                ...
                { CharacterStateId.Parried,new HashSet<CharacterStateId>{CharacterStateId.Idle,CharacterStateId.Hit,CharacterStateId.Dead, CharacterStateId.PostureBroken}},
